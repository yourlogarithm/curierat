...
class TestRoute(TestClient):
    def test_city_coordinates(self):
        ...
        coordinates = OpenRouteService._get_coordinates_of_city('Timisoara')
        self.assertAlmostEqual(lat, coordinates.latitude, delta=0.01)
        self.assertAlmostEqual(long, coordinates.longitude, delta=0.01)
